...
class DoomFire:
    ...
    def draw_fire(self):
        # Draw the fire on the fire surface
    ...
    def move_fire(self):
        # Move the fire horizontally
        self.x = (self.x - self.speed) % -WIDTH

    @staticmethod
    def get_palette():
        # Generate the color palette for the fire
        palette = [(0, 0, 0)]
